...
namespace RedisSessionState_Poc.ViewModels
{
    public class ProductListViewModel : BaseViewModel
    {
        ...
        //        .Select(x => new ProductImpressionsViewModel() { SKU = x.SKU, Name = x.Name, CategoryName = x.CategoryName, BrandName = x.Attributes?.ValueFromSelectValue(Libraries.ECommerce.Utilities.ZnodeConstant.Brand), SearchKeyword = SearchKeyword, ProductPrice = x.RetailPrice }).ToList();
